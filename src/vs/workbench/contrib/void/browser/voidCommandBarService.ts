...
// interface / decorator / 型定義は循環 import を避けるため
// voidCommandBarServiceInterface.ts に置いてある。**decorator を値として使う側は
// 必ずそちらから import すること** (ここからの再 export は既存 import 元の互換用)。
export { IVoidCommandBarService } from './voidCommandBarServiceInterface.js';
export type { CommandBarStateType, VoidCommandBarProps } from './voidCommandBarServiceInterface.js';
