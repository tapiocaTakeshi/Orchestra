...
// IChatThreadService の interface / decorator は循環 import を避けるため
// chatThreadServiceInterface.ts に分離してある (理由はそのファイルのコメント参照)。
// 既存の import 元を壊さないよう、ここから再 export しておく。
export { IChatThreadService };
