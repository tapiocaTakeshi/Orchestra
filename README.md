...
- ✨ **かんたんモード** — 初めての方向けに、IDE 的な部品 (アクティビティバー・ステータスバー・ミニマップ等) を隠し、ホーム画面と AI チャットだけのシンプルな画面で始められます。慣れたら「上級者モード」で通常の VS Code の表示に戻せます。詳しくは [docs/simple-mode.md](./docs/simple-mode.md)。
