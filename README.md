...
- 📱 **スマホからのリモートコントロール** — [Orchestra-Mobile](https://github.com/tapiocaTakeshi/Orchestra-Mobile) から、エージェントへの指示・カンバン・Division プロジェクトの管理を手元の端末で行えます。詳細は [docs/REMOTE-CONTROL.md](./docs/REMOTE-CONTROL.md) をご覧ください。
