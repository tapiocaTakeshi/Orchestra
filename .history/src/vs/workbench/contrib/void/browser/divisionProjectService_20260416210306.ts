...
=======
	/** Remove a division project by projectId */
	removeProject(projectId: string): Promise<void>;
>>>>>>> a35a5595 (feat: Refactor Division Project Service to sync project data with Supabase, update project ID handling, and remove Clerk authentication dependencies.)
}
